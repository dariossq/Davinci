<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/produccion/masterPrincipal.Master" AutoEventWireup="true" CodeBehind="WebBuscar.aspx.cs" Inherits="WebVista.produccion.produccion.Administracion.Buscar.WebBuscar" %>
                                ...
                                <div class="form-horizontal form-label-left">
                                    ...
                                    <div class="item form-group">
                                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Libro">
                                            Buscar por<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                           
                                        <asp:DropDownList ID="DdlBuscarPor" runat="server" AutoPostBack="true" AppendDataBoundItems="True" CssClass="form-control"
                                            ToolTip="Lista de profesion">
                                            <asp:ListItem Value="Atores">Ator</asp:ListItem>
                                            <asp:ListItem Value="Libros">Libro</asp:ListItem>
                                            <asp:ListItem Value="Ano">Año</asp:ListItem>
                                        </asp:DropDownList>
                                       <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="mensaje"
                                            ErrorMessage="***" ControlToValidate="DdlPersona" ForeColor="Red"
                                 ...
                                 <%--   <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                      ...
                                      <div class="item form-group">
                                        ...
                                        <asp:DropDownList ID="DdlPersona" runat="server" AutoPostBack="true" AppendDataBoundItems="True" CssClass="form-control"
                                            ToolTip="Lista de profesion" OnSelectedIndexChanged="DdlPersona_SelectedIndexChanged">
                                        </asp:DropDownList>
